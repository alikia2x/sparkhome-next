...
export default function SuggestionBox(props: { children?: React.ReactNode; style?: "default" | "image" }) {
	...
	if (style == "image") {
		return (
			<div
				...
				dark:text-white ${settings.bgBlur ? "backdrop-blur-sm bg-white/40 dark:bg-black/40" : "bg-white dark:bg-zinc-800"}
